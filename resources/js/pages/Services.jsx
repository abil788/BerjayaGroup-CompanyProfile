        ...
        <div className="w-full">
            ...
            <section className="bg-[#2f3131] text-white py-20 px-6 md:px-16 border-b border-[#dfc0b2] relative">
                ...
                <div className="relative z-10 max-w-[1440px] mx-auto">
                    <span className="text-[#f47321] font-mono text-xs uppercase tracking-widest font-bold block mb-2">{s.badge}</span>
                ...
                <div className="max-w-[1440px] mx-auto">
                    {loading ? (
                        <div className="space-y-12">
                            {[1,2,3].map(i => <div key={i} className="h-80 bg-gray-200 animate-pulse border border-[#dfc0b2]"></div>)}
                        </div>
                    ) : (
                                ...
                                return (
                                    <div key={service.id} className={`flex flex-col lg:flex-row gap-12 border-b border-[#dfc0b2]/40 pb-16 last:border-0 last:pb-0 ${isEven ? '' : 'lg:flex-row-reverse'}`}>
                                        ...
                                        <div className="w-full lg:w-1/2 flex flex-col justify-center">
                                            ...
                                            <h2 className="font-sans font-black text-3xl uppercase text-[#1a1c1c] tracking-tight mb-4">{service.title}</h2>
                                            <h3 className="font-sans font-bold text-base text-[#595f67] mb-6">{service.subtitle}</h3>
                                            <p className="text-gray-600 font-sans text-sm leading-relaxed mb-8">{service.description}</p>
                                            {service.details && (
                                                <div className="bg-white border border-[#dfc0b2] p-6">
                                                    <h4 className="font-mono text-xs uppercase text-[#9e4300] font-bold tracking-widest mb-4">{s.techSpecs}</h4>
                                                    <ul className="grid grid-cols-2 gap-4 font-mono text-xs text-[#595f67]">
                                                        {service.details.map((detail, dIdx) => (
                                                            <li key={dIdx} className="flex items-center gap-2">
                                                                <span className="w-2 h-2 bg-[#f47321]"></span>{detail}
                                                            </li>
                                                        ))}
                                                    </ul>
                                                </div>
                                            ...
                                            <div className="mt-8 flex gap-4">
                                                <button onClick={() => navigate('/contact')} className="bg-[#f47321] text-white px-6 py-3 font-mono text-xs uppercase tracking-widest font-bold hover:bg-[#9e4300] transition-colors cursor-pointer">
                                                    {s.inquire}
                                                </button>
                                            </div>
                                        </div>
            ...
            <section className="bg-[#2f3131] text-white py-16 px-6 md:px-16 border-t-4 border-[#9e4300]">
                <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
                    <div className="lg:col-span-1">
                        <span className="text-[#f47321] font-mono text-xs uppercase tracking-widest block mb-2">{s.metricsBadge}</span>
                        <h2 className="font-sans font-black text-2xl uppercase tracking-tight">{s.metricsTitle}</h2>
                        <p className="text-gray-400 font-sans text-sm mt-3 leading-relaxed">{s.metricsDesc}</p>
                    </div>
                    <div className="lg:col-span-2 grid grid-cols-2 md:grid-cols-4 gap-6 font-mono">
                        <div className="border border-gray-700 p-6 text-center bg-[#1a1c1c]">
                            ...
                            <p className="text-xs text-gray-400 uppercase tracking-widest mt-1">{s.fatalities}</p>
                        </div>
                        <div className="border border-gray-700 p-6 text-center bg-[#1a1c1c]">
                            <p className="text-[#f47321] font-bold text-3xl">0.82</p>
                            <p className="text-xs text-gray-400 uppercase tracking-widest mt-1">{s.emr}</p>
                        </div>
                        <div className="border border-gray-700 p-6 text-center bg-[#1a1c1c]">
                            <p className="text-[#f47321] font-bold text-3xl">100%</p>
                            <p className="text-xs text-gray-400 uppercase tracking-widest mt-1">{s.iso}</p>
                        </div>
                        <div className="border border-gray-700 p-6 text-center bg-[#1a1c1c]">
                            <p className="text-[#f47321] font-bold text-3xl">10M+</p>
                            <p className="text-xs text-gray-400 uppercase tracking-widest mt-1">{s.hours}</p>
                        </div>
                    </div>
                </div>
            </section>
